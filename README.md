...
| `docker-mailbox` | Multi-mailbox IMAP/SMTP control plane exposed as a REST API and MCP server on a single port for reading, searching, sending, and deleting mail. | `claude plugin install docker-mailbox@psyb0t` | [docker-mailbox](https://github.com/psyb0t/docker-mailbox) |
